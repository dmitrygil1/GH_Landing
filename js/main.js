...
const tabletBreakpoint = window.matchMedia('(max-width:1000px) and (min-width:768px)');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const tabletBreakpointChecker = function () {
      if (tabletBreakpoint.matches) {
        document.querySelector('.textWaveAnimation svg').setAttribute('viewBox', '0 0 691 700')
